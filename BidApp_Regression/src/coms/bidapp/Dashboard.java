...
public class Dashboard extends BaseFile{			
			...
			@Test (description="TestPagetitle", groups="Dashboard")
			public void TestpagelinkandText(){
				
				driver.findElement(By.xpath(".//*[@id='footer']/table/tbody/tr/td[4]/a/img")).click();
				String ExpectedText="Discussion Board page";
