...
{
String path="D:/WORK/BidApp_Regression/test-output/emailable-report.html";

String[] to = {"mahadev@triconinfotech.com"};
String[] cc = {"mahadev@triconinfotech.com"};
String[] bcc = { "mahadev.is57@gmail.com"};

SendMails.sendMail("mahadev.tricon@gmail.com",
					"Tricon@1234",
					"smtp.gmail.com",
					"465",
					"true",
					...
					cc,
					bcc,
					"CorpBuzz_Regression-TestNg_Report-01",
					"Success",
					path,
					reportFileName);
				}
